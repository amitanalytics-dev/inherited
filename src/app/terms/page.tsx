...
export const metadata: Metadata = {
  ...
  description: 'Inherited Skincare official terms of service.',
}

const POLICY_HTML = `<div class="rte">
        <p><b>OVERVIEW</b></p>
<p>This website is operated by Inherited Skincare. Throughout the site, the terms “we”, “us” and “our” refer to Inherited Skincare. Inherited Skincare  offers this website, including all information, tools and services available from this site to you, the user, conditioned upon your acceptance of all terms, conditions, policies and notices stated here. </p>
...
<p id="privacy_policy"><b>SECTION 20 - CONTACT INFORMATION</b></p>
<p>Questions about the Terms of Service should be sent to us at<span> </span><b>hello@Inherited Skincare.com.</b></p>
...
<p>When you provide us with personal information to complete a transaction, verify your payment information, place an order, arrange for a delivery or return a purchase, we imply that you consent to our collecting it and using it for that specific reason only.</p>
<p>If we ask for your personal information for a secondary reason, like marketing, we will either ask you directly for your expressed consent, or provide you with an opportunity to say no. </p>
<p>How do I withdraw my consent?</p>
<p>If after you opt-in, you change your mind, you may withdraw your consent for us to contact you, for the continued collection, use or disclosure of your information, at anytime, by contacting us at<span> </span><a href="mailto:hello@inheritedskincare.com"><b>hello@inheritedskincare.com</b></a><b>.</b></p>
...
<p>For more insight, you may also want to read Shopify’s Terms of Service and Privacy Statement.</p>
...
<p>In particular, remember that certain providers may be located in or have facilities that are located in a different jurisdiction than you. So if you elect to proceed with a transaction that involves the services of a third-party service provider, then your information may become subject to the laws of the jurisdiction(s) in which that service provider or its facilities are located.</p>
<p>Links</p>
...
<p>By using this site, you represent that you are at least the age of majority in your country of residence, or that you are the age of majority in your country of residence and you have given us your consent to allow any of your minor dependents to use this site.</p>
...
<p id="refund">If you would like to: access, correct, amend or delete any personal information we have for you, please let us know by emailing<span> </span><b>hello@inheritedskincare.com</b>.</p>`
      ...
      <div className="bg-brand-warm border-b border-brand-warm/80 py-10 md:py-12">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="font-body text-xs text-brand-muted mt-3">
            Official policy of Inherited Skincare.
          </p>
        </div>
      </div>
      <div className="max-w-3xl mx-auto px-4 sm:px-6 lg:px-8 py-10 md:py-12">
        <div
          className="font-body text-sm text-brand-muted leading-relaxed [&_b]:text-brand-dark [&_strong]:text-brand-dark [&_h2]:font-display [&_h2]:text-2xl [&_h2]:text-brand-dark [&_h2]:mt-8 [&_h2]:mb-3 [&_p]:mb-3 [&_ul]:list-disc [&_ul]:pl-6 [&_ul]:mb-3 [&_li]:mb-1 [&_a]:text-brand-amber [&_a]:underline"
